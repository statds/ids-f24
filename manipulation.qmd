...
## Extracting and Analyzing Census Tract Data

This section was authored by **Mohammad Shahriyar Parvez**, 
...
This section explains how to access data from the US 
...
relevant to poverty analysis, refer to the 
[Census Bureau’s guidelines on poverty measurement](https://www.census.gov/topics/income-poverty/poverty/guidance/poverty-measures.html) 
...
Bureau’s website, specifically on the 
[Cartographic Boundary Files](https://www.census.gov/geographies/mapping-files/time-series/geo/carto-boundary-file.html) page or the 
[TIGER/Line Shapefiles](https://www.census.gov/geographies/mapping-files/time-series/geo/tiger-line-file.html) page.
...
#### Create new column from old columns
...
position; see the 
[pandas documentation on indexing and selecting data](https://pandas.pydata.org/pandas-docs/stable/user_guide/indexing.html) for more details.)
...
reassignment. For additional details, refer to the 
[pandas documentation on `drop`](https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.drop.html).
...
though they may require additional considerations. 
For more details, refer to the 
[Esri ArcGIS documentation on joins and relates](https://desktop.arcgis.com/en/arcmap/latest/manage-data/tables/about-joining-and-relating-tables.htm).
