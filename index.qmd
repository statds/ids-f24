...
+ Xu Deyu
    - Proficiently apply Python to solve various data problems and lay a good foundation for data processing in scientific research projects.
    - Develop my ability to independently solve data problems.
...
+ Xu, Deyu
  + Proficient in using Python for data processing
  + Have a basic understanding of data science
  + Use Git and GitHub to manage my own code proficiently
