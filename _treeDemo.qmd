...
1. 1.10. Decision Trees. (n.d.). Scikit-learn. https://scikit-learn.org/1.5/modules/tree.html [@sklearn_decision_tree].
2. Baladram, S. (2024, October 11). Decision Tree Regressor, Explained: A Visual Guide with Code Examples. Medium. https://towardsdatascience.com/decision-tree-regressor-explained-a-visual-guide-with-code-examples-fbd2836c3bef [@baladram2024].
3. GeeksforGeeks. (2024, May 17). Decision tree. GeeksforGeeks. https://www.geeksforgeeks.org/decision-tree/ [@geeksforgeeks_decision_tree].