...
![Map of all the locations in NYC where I have eaten a bagel](images/spatial_data_visualization/Bagels_map.png)
...
![Image of MyMaps UI. As we can see, there is a very small extent of functionality.](images/spatial_data_visualization/MyMap.png)
...
![Example of Landcover classifcation model in GEE](images/spatial_data_visualization/GEE_example.png)
...
![](images/spatial_data_visualization/Select_Project.png)
...
![Where to navigate to generate API key](images/spatial_data_visualization/Make_API_key.png)
...
![Output of example code](images/spatial_data_visualization/gmplot_output.png)
...
![Heat map output; *Remark: multiple gmplot html outputs might not reliably work for a single script*](images/spatial_data_visualization/heatmap_output.png)
