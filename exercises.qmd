...
1. **Game 24**
   ...
   1. How many possible ways are there to check for a solution?
   ...
   variables.
    1. Data cleaning.
       ...
       are close to completely missing? 
        + Are there redundant information in the data? Try storing the
    ...
    1. Data analysis.
	    + The addresses of NYC police precincts are stored in
